 ...
 */
final class Version20240425142416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_image (id INT NOT NULL, product_id INT DEFAULT NULL, PRIMARY KEY(id))');
